    ...
    */
    'provider_templates' => [
        ...
        'github-copilot' => [
            ...
            'description' => 'GitHub device login — subscription-based pricing (Free $0 / Pro $10 / Pro+ $39 per month)',
            'base_url' => 'https://api.individual.githubcopilot.com',
            'api_key_url' => 'https://github.com/settings/copilot',
            'auth_type' => 'device_flow',
            // Subscription-based — costs shown as premium request multipliers, not per-token
            /** @link https://docs.github.com/en/copilot/reference/ai-models/supported-models */
            'models' => [
                [
                    'model_name' => 'gpt-4.1',
                ...
                [
                    'model_name' => 'gpt-5.1-codex',
                    'display_name' => 'GPT-5.1 Codex (OpenAI)',
                    'capability_tags' => ['code', 'agent'],
                    'context_window' => 200000,
                    'max_tokens' => 16384,
                    'cost_per_1m' => ['input' => null, 'output' => null, 'cache_read' => null, 'cache_write' => null],
                ],
                [
                    'model_name' => 'gpt-5.1-codex-mini',
                    'display_name' => 'GPT-5.1 Codex Mini (OpenAI)',
                ...
                [
                    'model_name' => 'gpt-5.1-codex-max',
                    'display_name' => 'GPT-5.1 Codex Max (OpenAI)',
                    'capability_tags' => ['code', 'agent'],
                    'context_window' => 200000,
                    'max_tokens' => 16384,
                    'cost_per_1m' => ['input' => null, 'output' => null, 'cache_read' => null, 'cache_write' => null],
                ...
                [
                    ...
                    'display_name' => 'GPT-5.2 Codex (OpenAI)',
                    'capability_tags' => ['code', 'agent'],
                    'context_window' => 200000,
                    'max_tokens' => 16384,
                    'cost_per_1m' => ['input' => null, 'output' => null, 'cache_read' => null, 'cache_write' => null],
                ...
                [
                    ...
                    'display_name' => 'GPT-5.3 Codex (OpenAI)',
                    'capability_tags' => ['code', 'agent'],
                    'context_window' => 200000,
                    'max_tokens' => 16384,
                    'cost_per_1m' => ['input' => null, 'output' => null, 'cache_read' => null, 'cache_write' => null],
                ...
                [
                    ...
                    'display_name' => 'Raptor Mini (Fine-tuned GPT-5 Mini)',
                    'capability_tags' => ['code'],
                    'context_window' => 200000,
                    'max_tokens' => 16384,
                    'cost_per_1m' => ['input' => null, 'output' => null, 'cache_read' => null, 'cache_write' => null],
